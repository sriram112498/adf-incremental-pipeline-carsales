...
#Incremental RUN
if spark.catalog.tableExists('cars_catalog.gold.dim_branch'):
    delta_tbl = DeltaTable.forPath(spark, "abfss://gold@cardobbydatalake.dfs.core.windows.net/dim_branch")
...
#Initial RUN
    ...
    df_final.write.format("delta")\
            .mode('overwrite')\
            .option("path","abfss://gold@cardobbydatalake.dfs.core.windows.net/dim_branch")\
